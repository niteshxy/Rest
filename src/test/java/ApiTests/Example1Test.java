...
public class Example1Test {
	...
	/*
	 * Second, we should do setup operations, get JSON response from the API and
	 * put it into JsonPath object Then we will do query and manipulations with
	...
	public void setup() {
		...
		RestUtil.createSearchQueryPath("barack obama", "videos.json", "num_of_videos", "4"); // Construct
																								// the
																								// path
	...
	public void T02_SearchTermTest() {
		...
		// assertThat(jp.get("api-info.title"), containsString("barrack
		// obama"));
	}
